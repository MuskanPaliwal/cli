...
// TranscriptSanitizer, TranscriptFetcher, SubagentSessionResolver,
// SessionBaseDirProvider, ModelExtractor, SkillEventExtractor,
// SessionEndBudgeter) are intentionally excluded — their As* helpers resolve by
// type assertion alone (see builtinCapability), with no DeclaredCaps gate.
