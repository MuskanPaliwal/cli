...
Examples:
  ...
  entire configure --summarize-timeout-seconds 300   # 5m deadline for explain --generate`,
	...
	cmd.Flags().StringVar(&summarizeProvider, flagSummarizeAgent, "", "Set the provider used by explain --generate (e.g., claude-code, codex, gemini, antigravity, pi, opencode, cursor, copilot-cli)")
